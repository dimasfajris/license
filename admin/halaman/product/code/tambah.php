...
if (isset($_POST['tambah'])) {
    ...
    if (tambah($_POST) > 0) {
        echo "<script>
              ...
              document.location.href = 'index.php?page=atsa';
            </script>";
    } else {
        echo "<script>
...
<h3 style="text-align: center;">ATS PERIODE A</h3>
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Input ATS</h4>
        <div class="form-panel">
            <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">Deskription</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="satuan" name="satuan" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">Volume</label>
                        <div class="col-lg-10">
                            <input class=" form-control" id="volume" name="volume" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                            <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="2020-01-01" class="input-append date dpYears">
                                <input type="text" readonly="" value="01-01-2014" size="16" class="form-control" name="start_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                            <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="2020-01-01" class="input-append date dpYears">
                                <input type="text" readonly="" value="01-01-2014" size="16" class="form-control" name="end_date">
                                <span class="input-group-btn add-on">
                                    <button class="btn btn-theme" type="button"><i class="fa fa-calendar"></i></button>
                                </span>
                            </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="perangkat" name="perangkat" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">Tahun</label>
                        <div class="col-lg-10">
                            <input class=" form-control" id="tahun" name="tahun" type="text" required />
                        </div>
                    </div>
