...
function tambah($data)
{
    ...
    $sql = "INSERT INTO sign VALUES ('', '$nama_lisensi', '$merk', '$versi', '$start_ats', '$end_ats', '$tipe',  '$start_date', '$end_date', '$keterangan')";
...
function delete($id)
{
    ...
    mysqli_query($koneksi, "DELETE FROM sign WHERE id = $id");
    return mysqli_affected_rows($koneksi);
}
