...
$data = query("SELECT * FROM meterai WHERE id = $id")[0];
...
if (isset($_POST['tambah'])) {
    ...
    if (edit($_POST) > 0) {
        echo "<script>
            ...
            document.location.href = 'index.php?page=meterai';
          </script>";
    } else {
        echo "<script>
            alert('Update data Gagal!');
            document.location.href = 'index.php?page=editmeterai';
          </script>";
    }
}
?>
...
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Edit Data Lisensi E-Meterai</h4>
