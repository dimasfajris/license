                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    ...
                                    <a class="btn btn-outline-warning btn-sm" href="index.php?page=editmeterai&id=<?= $data['id']; ?>">EDIT | </a>
                                    <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure?')" href="index.php?page=deletemeterai&id=<?= $data['id']; ?>">HAPUS</a>
                                </center>
                            </td>
                            <?php $x++; ?>
                        <?php endforeach; ?>
