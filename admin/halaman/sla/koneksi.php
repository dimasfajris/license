...
function tambah($data)
{
    ...
    $sql = "INSERT INTO resolution_time VALUES ('', '$account_number', '$account_name', '$product', '$qty', '$unit', '$folder_name', '$license_key', '$custom_label1', '$type', '$number', '$order_date', '$order_qty', '$support_level', '$license_coverage_end_date', '$contract_end_date')";
...
function edit($data)
{
    ...
    $sql = " UPDATE resolution_time SET 
...
{
    $query = "SELECT * FROM resolution_time
                WHERE
...
function delete($id)
{
    ...
    mysqli_query($koneksi, "DELETE FROM resolution_time WHERE id = $id");
    return mysqli_affected_rows($koneksi);
