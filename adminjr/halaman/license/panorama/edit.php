...
$data = query("SELECT * FROM panorama WHERE id = $id")[0];
...
if( isset($_POST['tambah'] ) ) {
  ...
  if( edit($_POST) > 0 ) {
    ...
    echo "<script>
            ...
            document.location.href = 'index.php?page=editpanorama';
          </script>";
  }
...
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Edit License Panorama</h4>
