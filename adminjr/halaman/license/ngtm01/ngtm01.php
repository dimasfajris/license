                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailngtm01&id=<?= $data['id']; ?>">DETAIL | </a>
                                    <a class="btn btn-outline-warning btn-sm" href="index.php?page=editngtm01&id=<?= $data['id']; ?>">EDIT | </a>
                                </center>
                            </td>
                            <?php $x++; ?>
                        <?php endforeach; ?>
