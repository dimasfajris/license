...
function tambah($data)
{
    ...
    $sql = "INSERT INTO fortigate VALUES ('', '$name',  '$expiration')";
...
function delete($id)
{
    ...
    mysqli_query($koneksi, "DELETE FROM fortigate WHERE id = $id");
    return mysqli_affected_rows($koneksi);
