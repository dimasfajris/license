                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailfortigate&id=<?= $data['id']; ?>">DETAIL | </a>
                                    <a class="btn btn-outline-warning btn-sm" href="index.php?page=editfortigate&id=<?= $data['id']; ?>">EDIT | </a>
