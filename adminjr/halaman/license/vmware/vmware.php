                ...
                <tbody>
                    ...
                    <?php foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a class="btn btn-outline-success btn-sm" href="index.php?page=detailvmware&id=<?= $data['id']; ?>">DETAIL | </a>
                                    <a class="btn btn-outline-warning btn-sm" href="index.php?page=editvmware&id=<?= $data['id']; ?>">EDIT | </a>
                                </center>
                            </td>
                            <?php $x++; ?>
                        <?php endforeach; ?>
