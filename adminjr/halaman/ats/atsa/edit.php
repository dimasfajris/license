...
$data = query("SELECT * FROM atsa WHERE id = $id")[0];
...
if( isset($_POST['tambah'] ) ) {
  ...
  if( edit($_POST) > 0 ) {
    ...
    echo "<script>
            ...
            document.location.href = 'index.php?page=editatsa';
          </script>";
  }
...
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Edit ATS Periode A</h4>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="deskripsi"
                                value="<?= $data['deskripsi']; ?>" name="deskripsi" type="text"
                                required />
                        </div>
                    </div>
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="satuan"
                                value="<?= $data['satuan']; ?>" name="satuan" type="text"
                                required />
                        </div>
                    </div>
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="volume" value="<?= $data['volume']; ?>"
                                name="volume" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
