...
function tambah($data)
{
    ...
    $sql = "INSERT INTO atsb VALUES ('', '$deskripsi', '$satuan', '$volume', '$harga', '$start_date', '$end_date', '$perangkat', '$tahun')";
...
function delete($id)
{
    ...
    mysqli_query($koneksi, "DELETE FROM atsb WHERE id = $id");
    return mysqli_affected_rows($koneksi);
