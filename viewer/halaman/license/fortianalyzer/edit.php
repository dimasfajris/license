...
$data = query("SELECT * FROM fortianalyzer WHERE id = $id")[0];
...
if( isset($_POST['tambah'] ) ) {
  ...
  if( edit($_POST) > 0 ) {
    ...
    echo "<script>
            ...
            document.location.href = 'index.php?page=editfortianalyzer';
          </script>";
  }
...
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Edit License Fortianalyzer</h4>
