...
if( isset($_POST['tambah'] ) ) {
    ...
    if( tambah($_POST) > 0 ) {
      echo "<script>
              ...
              document.location.href = 'index.php?page=fortianalyzer';
            </script>";
    } else {
      echo "<script>
              alert('Penambahan data Gagal!');
              document.location.href = 'index.php?page=tambahfortianalyzer';
            </script>";
    }
...
<h3 style="text-align: center;">Fortianalyzer LICENSE</h3>
<div class="row mt">
    <div class="col-lg-12">
        <h4><i class="fa fa-angle-right"></i> Input License Fortianalyzer</h4>
