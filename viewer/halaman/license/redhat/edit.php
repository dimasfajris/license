            ...
            <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="Subscription_Number" value="<?= $data['Subscription_Number']; ?>" name="Subscription_Number" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">Subscription Name</label>
                        <div class="col-lg-10">
                            <input class=" form-control" id="Subscription_Name" value="<?= $data['Subscription_Name']; ?>" name="Subscription_Name" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="cname" class="control-label col-lg-2">Contract Number</label>
                        <div class="col-lg-10">
                            <input class=" form-control" id="Contract_Number" value="<?= $data['Contract_Number']; ?>" name="Contract_Number" type="text" required />
                        </div>
                    </div>
                    <div class="form-group ">
