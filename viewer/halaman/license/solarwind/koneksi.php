...
function tambah($data)
{
    ...
    $sql = "INSERT INTO solarwind VALUES ('', '$name',  '$expiration')";
...
function delete($id)
{
    ...
    mysqli_query($koneksi, "DELETE FROM solarwind WHERE id = $id");
    return mysqli_affected_rows($koneksi);
