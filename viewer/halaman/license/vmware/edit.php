                ...
                <form class="cmxform form-horizontal style-form" id="commentForm" method="POST" action=""
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="account_number"
                                value="<?= $data['account_number']; ?>" name="account_number" type="text"
                                required />
                        </div>
                    </div>
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="account_name"
                                value="<?= $data['account_name']; ?>" name="account_name" type="text"
                                required />
                        </div>
                    </div>
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class=" form-control" id="product" value="<?= $data['product']; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                            <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="2020-01-01"
                                ...
                                <input type="text" readonly="" value="<?= $data['order_date']; ?>" size="16" class="form-control"
                                    name="order_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                            <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="2020-01-01"
                                class="input-append date dpYears">
                                <input type="text" readonly="" value="<?= $data['license_coverage_end_date']; ?>" size="16" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                            <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="2020-01-01"
                                class="input-append date dpYears">
                                <input type="text" readonly="" value="<?= $data['contract_end_date']; ?>" size="16" class="form-control"
